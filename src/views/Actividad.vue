      ...
      preguntas: [
        {
          ...
          mensaje_correcto:
            '¡Excelente trabajo! Se evidencia un buen dominio de los conceptos fundamentales sobre arquitectura de la información, diseño de interfaces, uso de HTML y CSS, y tecnologías en el desarrollo de aplicaciones web.',
          mensaje_incorrecto:
